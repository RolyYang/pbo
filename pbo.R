...
pbo <- function(m,s=4,f=Omega,threshold=0,inf_sub=6,allow_parallel=FALSE) {
...
# compute and plot
my_pbo <- pbo(M,S,Omega,threshold=1)
summary(my_pbo)
histogram(my_pbo)
...
xyplot(my_pbo,plotType="selection",sel_threshold=0,cex=1.2)
